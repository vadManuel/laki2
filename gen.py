...
def main():
    generateImage(400, 5, 10, "Cross")


def generateImage(imSize, blurAmount=50, noiseProb=50, filename="dab", forceLetterColor=None, forceBackColor=None, forceShapeColor=None, forceLetter=None, forceShape='Cross'):
